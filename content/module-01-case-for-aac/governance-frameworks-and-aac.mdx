...
import quizData from '@site/src/quizzes/module-01-case-for-aac.json';
...
![Gemara 7-layer model in OSI style with definition layers L1–L3 at the bottom, Layer 4 (Sensitive Activities) as the pivot point with CALM annotated, and measurement layers L5–L7 at the top](/img/m01-gemara-7-layers-overview.svg)
...
![Three-zone sandwich showing Gemara Layers 1–3 (definition) at top, Layer 4 with CALM Architecture (.architecture.json) at the centre, and Layers 5–7 (measurement) at bottom — CALM is the pivot point Gemara Section 8 calls for](/img/m01-calm-as-layer-4.svg)
...
- [OpenSSF Gemara whitepaper](https://openssf.org/projects/gemara/) — the primary source for the full Gemara 7-layer model and layer-by-layer analysis
