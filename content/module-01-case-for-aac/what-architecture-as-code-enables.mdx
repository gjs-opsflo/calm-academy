...
![Three-layer stack diagram showing infrastructure, architecture, and policy as three layers — the CALM architecture layer is the source artifact for git history](/img/m01-aac-stack.svg)
...
![Circular flywheel diagram with four stages: validate, detect drift, enforce, improve patterns — showing the governance loop powered by CALM](/img/m01-calm-ecosystem-flywheel.svg)
